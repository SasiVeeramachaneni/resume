...
export function Education({
  ...
  const handleAddEducation = () => {
    const emptyFields = educations.some(
      (edu) => edu.degree.trim() === "" || edu.college.trim() === "",
    );
    if (emptyFields) {
      const newErrors = educations
        .map((edu, index) =>
          edu.degree.trim() === "" || edu.college.trim() === "" ? index : -1,
        )
  ...
  const handleChange = (index: number, field: string, value: string) => {
    ...
    if (errors.includes(index)) {
      ...
      if (
        newEducations[index].degree.trim() !== "" &&
        newEducations[index].college.trim() !== ""
      ) {
          ...
          >
            <div>
              <TextInput
                ...
                size="md"
                onChange={(e) =>
                  handleChange(index, "degree", e.currentTarget.value)
                }
                ...
                style={{
                  fontWeight: "bold",
                  border:
                    errors.includes(index) && edu.degree.trim() === ""
                      ? "1px solid red"
                      : "none",
                }}
                styles={{
              ...
              >
                <TextInput
                  ...
                  size="sm"
                  onChange={(e) =>
                    handleChange(index, "discipline", e.currentTarget.value)
                  }
                  onFocus={() => onEditingChange(index)}
                  onBlur={() => onEditingChange(null)}
                  style={{
                ...
                <TextInput
                  ...
                  size="sm"
                  onChange={(e) =>
                    handleChange(index, "percentage", e.currentTarget.value)
                  }
                  onFocus={() => onEditingChange(index)}
                  onBlur={() => onEditingChange(null)}
              ...
              >
                <TextInput
                  ...
                  size="sm"
                  onChange={(e) =>
                    handleChange(index, "college", e.currentTarget.value)
                  }
                  onFocus={() => onEditingChange(index)}
                  onBlur={() => onEditingChange(null)}
                  style={{
                    ...
                    width: "300px",
                    border:
                      errors.includes(index) && edu.college.trim() === ""
                        ? "1px solid red"
                        : "none",
                  }}
                  styles={{
