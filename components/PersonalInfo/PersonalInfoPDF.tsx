...
export const PersonalInfoPDF: React.FC<PersonalInfoPDFProps> = ({
  resumeData,
}) => {
  const {
    personalInfo,
  ...
  const { name, title, aboutMe, phoneNumber, email, linkedIn, github, image } =
    personalInfo;
  ...
  const sectionItems = [
    ...
    settings.isPersonalProjects && (
      <ProjectsPDF key="projects" projects={projects} />
    ),
    settings.isCertifications && (
      <CertificationsPDF key="certifications" certifications={certifications} />
    ),
    ...
    (settings.isLanguages || hasLanguages) && (
      <LanguagesPDF key="languages" languages={languages} />
    ),
        ...
        <View style={styles.contactSection}>
          ...
          {email && (
            <View style={styles.inputContainer}>
              ...
              >
                <Path
                  d="M22 6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6zm-2 0l-8 5-8-5h16zm0 12H4V8l8 5 8-5v10z"
                  fill="#333"
                />
              </Svg>
          ...
          {settings.isLinkedIn && linkedIn && (
            <View style={styles.inputContainer}>
              ...
              <Link src={linkedIn} style={styles.linkText}>
                LinkedIn
              </Link>
            </View>
          )}
          {settings.isGithub && github && (
            <View style={styles.inputContainer}>
              ...
              <Link src={github} style={styles.linkText}>
                GitHub
              </Link>
            </View>
          )}
      ...
      {isClassicTemplate ? (
        ...
        <View style={styles.grid}>
          ...
          <View style={styles.col4}>
            ...
            {(settings.isLanguages || hasLanguages) && (
              <LanguagesPDF languages={languages} />
            )}
