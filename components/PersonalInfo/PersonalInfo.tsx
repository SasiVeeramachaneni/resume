        ...
        <Stack gap={0} style={{ width: isImage ? "87%" : "100%" }}>
          <input
            ...
            style={{
              ...
              backgroundColor:
                activeField === "name" ? "#eff8ff" : "transparent",
            }}
            value={name}
          ...
          <input
            ...
            style={{
              ...
              outline: "none",
              backgroundColor:
                activeField === "title" ? "#eff8ff" : "transparent",
            }}
            value={title}
          ...
          <Textarea
            ...
            style={{
              ...
              padding: 0,
              backgroundColor:
                activeField === "aboutMe" ? "#eff8ff" : "transparent",
            }}
            value={aboutMe}
      ...
      <Grid align="center" columns={12} p={0} m={0}>
        <Grid.Col span={3}>
          <TextInput
            ...
            style={{
              backgroundColor:
                activeField === "phoneNumber" ? "#eff8ff" : "transparent",
            }}
          />
        </Grid.Col>
        <Grid.Col span={3}>
          <TextInput
            ...
            style={{
              backgroundColor:
                activeField === "email" ? "#eff8ff" : "transparent",
            }}
          />
        </Grid.Col>
        <Grid.Col span={3}>
          <TextInput
            ...
            style={{
              backgroundColor:
                activeField === "linkedIn" ? "#eff8ff" : "transparent",
            }}
          />
        </Grid.Col>
        {isGithub && (
          <Grid.Col span={3}>
            <TextInput
              ...
              style={{
                backgroundColor:
                  activeField === "github" ? "#eff8ff" : "transparent",
              }}
            />
          </Grid.Col>
        )}
