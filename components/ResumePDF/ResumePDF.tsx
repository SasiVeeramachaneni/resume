...
import { Document, Page, View, StyleSheet, Font, Text, Image } from '@react-pdf/renderer';
...
const PhotoTemplatePDF: React.FC<{ resumeData: ResumeData }> = ({ resumeData }) => {
  ...
  return (
    <View style={photoPageStyles.container}>
      ...
      <View style={photoPageStyles.sidebar}>
        ...
        <View style={{ marginBottom: 15 }}>
          ...
          {personalInfo.phoneNumber && (
            <View style={photoPageStyles.sidebarField}>
              ...
              <Text style={photoPageStyles.sidebarValue}>{personalInfo.phoneNumber}</Text>
            </View>
          )}
          ...
          {personalInfo.email && (
            <View style={photoPageStyles.sidebarField}>
              ...
              <Text style={photoPageStyles.sidebarValue}>{personalInfo.email}</Text>
            </View>
          )}
          ...
          {settings.isLinkedIn && personalInfo.linkedIn && (
            <View style={photoPageStyles.sidebarField}>
              ...
              <Text style={photoPageStyles.sidebarValue}>{personalInfo.linkedIn}</Text>
            </View>
          )}
          ...
          {settings.isGithub && personalInfo.github && (
            <View style={photoPageStyles.sidebarField}>
              ...
              <Text style={photoPageStyles.sidebarValue}>{personalInfo.github}</Text>
            </View>
          )}
        </View>
        ...
        {settings.isCertifications && certifications && certifications.length > 0 && (
          <CertificationsPDF certifications={certifications} template="photo" />
        )}
        {(settings.isLanguages || hasLanguages) && languages && languages.length > 0 && (
      ...
      <View style={photoPageStyles.main}>
        ...
        {personalInfo.aboutMe && (
          <View style={{ marginBottom: 15 }}>
            ...
            <Text style={photoPageStyles.profileText}>{personalInfo.aboutMe}</Text>
          </View>
        )}
