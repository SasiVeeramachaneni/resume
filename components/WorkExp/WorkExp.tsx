    ...
    if ((e.ctrlKey || e.metaKey) && (e.key === "b" || e.key === "i")) {
      ...
      setTimeout(() => {
        ...
        textarea.setSelectionRange(
          start + syntax.length,
          start + syntax.length + selection.length,
        );
      }, 0);
      return;
    }
            ...
            <div>
              ...
              >
                <input
                  ...
                  style={{
                    ...
                    width: "400px",
                    border:
                      errors.includes(index) && exp.organization.trim() === ""
                        ? "1px solid red"
                        : "none",
                    fontSize: "20px",
                    outline: "none",
                ...
                <Group gap={1} pr={2}>
                  <TextInput
                    ...
                    size="sm"
                    onChange={(e) =>
                      handleChange(index, "from", e.currentTarget.value)
                    }
                    onFocus={() => onEditingChange(index)}
                    onBlur={() => onEditingChange(null)}
                    style={{
                      ...
                      width: "83px",
                      border:
                        errors.includes(index) && exp.from === ""
                          ? "1px solid red"
                          : "none",
                    }}
                  />
                  {!exp.isCurrent && (
                    <>
                      ...
                      <TextInput
                        ...
                        size="sm"
                        onChange={(e) =>
                          handleChange(index, "to", e.currentTarget.value)
                        }
                        onFocus={() => onEditingChange(index)}
                        onBlur={() => onEditingChange(null)}
              ...
              >
                <input
                  ...
                  value={exp.role}
                  onChange={(e) =>
                    handleChange(index, "role", e.currentTarget.value)
                  }
                  onFocus={() => onEditingChange(index)}
                  onBlur={() => onEditingChange(null)}
                  style={{
                ...
                <Checkbox
                  ...
                  onChange={(e) =>
                    handleChange(index, "isCurrent", e.currentTarget.checked)
                  }
                  size="sm"
                />
              </div>
                  ...
                  >
                    ...
                    {isFocused || !point.trim() ? (
                      <Textarea
                        ...
                        onKeyDown={(e) =>
                          handlePointKeyPress(e, index, pointIndex)
                        }
                        onFocus={() => {
